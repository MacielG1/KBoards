  ...
  return (
    <div>
      <aside
        ref={sidebarRef}
        className={cn(
          `group/sidebar relative z-[9999] flex flex-col overflow-x-hidden bg-neutral-200 dark:bg-neutral-800`,
      ...
      >
        <div
          className={cn(
            `absolute right-2 top-6 h-6 w-6 rounded-sm text-neutral-500 transition hover:text-neutral-900 group-hover/sidebar:opacity-100 dark:text-neutral-500 dark:hover:text-neutral-300 md:opacity-0 md:hover:opacity-100`,
          )}
          role="button"
          onClick={collapse}
        >
      ...
      >
        {isCollapsed && (
          <>
            <Menu
              role="button"
              className="absolute z-[99999] ml-2 mt-1 h-6 w-6 text-neutral-500  duration-200 hover:text-neutral-900 dark:hover:text-neutral-300"
              onClick={resetWidth}
            />
          </>
        )}
