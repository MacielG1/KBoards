...
export const Icons = {
  ...
  csv: (props: SVGProps<SVGSVGElement>) => (
    <svg fill="#000000" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" {...props} width="800px" height="800px" viewBox="0 0 548.29 548.291">
      <g>
        <path
